...
const profile = {
  ...
  intro:
    "我目前就读于南安普顿大学计算机科学本科，长期进行系统策划案撰写、商业游戏拆解分析与 Unity 玩法原型开发，希望进入游戏行业，从系统设计、玩法分析和原型验证的结合点创造真正对玩家体验有价值的内容。",
  education: "南安普顿大学 · 计算机科学本科 · 2024.09 - 2027.06",
...
const projects = [
  {
    title: "Moving Fortress 个人 Demo",
    subtitle: "Unity 个人项目 / 第三人称俯视角即时战斗",
    period: "2026.02 - 开发中",
    type: "Unity Demo",
    role: "独立完成",
    summary:
      "一款第三人称俯视角即时战斗游戏。玩家将驾驶木质战车完成高难度任务，在战斗、移动与火力调度之间持续做即时决策，重点展示我在玩法原型、战斗系统和交互逻辑上的落地能力。",
    contributions: [
      "使用 Unity 2023、C#、Blender 进行原型开发与迭代",
      "独立完成玩法雏形、敌我交互、战斗反馈与任务流程设计",
      "将策划思路快速转化为可运行 Demo，用于验证玩法节奏与系统可行性",
    ],
    links: [
      {
        label: "Bilibili 演示视频",
